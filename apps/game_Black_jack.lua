...
function drawDisplay()
    ...
    gpu.set(14, 11, 'Blackjack')
    gpu.set(14, 13, 'Правила:')
    gpu.set(14, 14, '1. Нужно набрать больше очков, чем у дилера.')
    gpu.set(14, 15, '2. Нельзя набирать больше 21 очка.')
    gpu.set(14, 16, '3. Победа приносит удвоенную ставку.')
    gpu.set(14, 17, '4. Ничья возвращает ставку.')
    gpu.set(14, 19, 'Более подробно можно найти в интернете.')
